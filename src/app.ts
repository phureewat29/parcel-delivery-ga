...
// const E1 = { name: 'E1', from: N1, to: N2, distance: 10 }
// const E2 = { name: 'E2', from: N2, to: N3, distance: 10 }
// const E3 = { name: 'E3', from: N3, to: N4, distance: 10 }
// const E4 = { name: 'E4', from: N4, to: N5, distance: 10 }
// const edges: Edge[] = [E1, E2, E3, E4]

// const T1 = { name: 'T1', capacity: 20, at: N1 }
// const T2 = { name: 'T2', capacity: 10, at: N2 }
// const T3 = { name: 'T3', capacity: 10, at: N3 }
// const trains: Train[] = [T1, T2, T3]

// const P1 = { name: 'P1', weight: 5, at: N1, dest: N3 }
// const P2 = { name: 'P2', weight: 5, at: N1, dest: N3 }
// const P3 = { name: 'P3', weight: 5, at: N4, dest: N5 }
// const P4 = { name: 'P4', weight: 5, at: N4, dest: N5 }
